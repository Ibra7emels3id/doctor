...
const NavBar = ({ showNav , HandleShowNavBar }) => {
    ...
    return (
        <nav className={` ${showNav ? 'left-[-3.5%] opacity-[1]' : 'left-[-50%] opacity-0'} bg-white w-[250px] fixed left-[-50%] opacity-0 transition-all duration-500  top-0 h-screen border-r border-blue`}>
